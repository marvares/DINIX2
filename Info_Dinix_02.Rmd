...
header-includes:
  ...
  \renewcommand{\tablename}{Tabla}  # Cambia el prefijo de tablas
---
\newpage
...
En el contexto de uso del análisis psicométrico de una escala, el objetivo usual del procedimiento estadístico llamado "Análisis Factorial" es la reducción de ítems, es decir, la creación de una versión que contenga menos ítems que la cantidad original pero que, a su vez, mantenga una estructura muy similar.
...
A fin de determinar esto, procederemos a realñizar
