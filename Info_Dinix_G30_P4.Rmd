...
INDI30_Factor<- convert_to_factor(INDI30, c(5,7:9,11,13,41))
...
colnames(PULCRO) <- c("Código", "Escala_Cog.", "Escala_Mot.", "Escala_Dis.","Edad_Mes", "Región", "Área", "Modalidad", "Departamento", "Quintil", "Inst_Pre_N3")
...
regmulti(PULCRO, PULCRO$Escala_Cog., c(5:11), nombres_vars = c("Edad en Meses", "Región", "Área", "Modalidad", "Departamento", "Quintil", "Instrucción Previa"), nombre_dep = "Escala Cognitiva")
```
...
1. Las únicas variables que realmente aportan a la explicación del puntaje en la Escala Cognitiva INDI son: 
  ...
  a. Departamento (Lima)
  a. Región Selva
  a. Que el participante haya tenido Instrucción previa la Nivel 3
  a. Que el participante no pueda determinar si tuvo Instrucción previa la Nivel 3
...
regmulti(PULCRO, PULCRO$Escala_Mot., c(5:11), nombres_vars = c("Edad en Meses", "Región", "Área", "Modalidad", "Departamento", "Quintil", "Instrucción Previa"), nombre_dep = "Escala Motora")
```
...
1. Las únicas variables que realmente aportan a la explicación del puntaje en la Escala Motora INDI son: 
...
regmulti(PULCRO, PULCRO$Escala_Dis., c(5:11), nombres_vars = c("Edad en Meses", "Región", "Área", "Modalidad", "Departamento", "Quintil", "Instrucción Previa"), nombre_dep = "Escala Disposicional")
```
...
1. Las únicas variables medidas que realmente aportan a la explicación del puntaje en la Escala Cognitiva INDI son: 
  ...
  a. Edad
  a. Región Selva
  a. Que el participante provenga de la Región Rural (en detrimento)
