...
PRELIMPIO <- ayudin(dataframe = INDI45, columnas = c(1, 43:105)) # Extraigo solo valores no NA y numéricos del df original
...
```{r 45_P2_Inversión_Items, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE, results='asis'}
...
```{r 45_P2_Discriminante, message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE, results='asis'}
# Vamos a generar un DF con la data necesaria
# Excluir columnas por índice
DISCRI <- LIMPIO [, -c(36:38,43:47,50, 54:60, 64:68, 79:80)]  # Excluir las columnas que corresponden. alos ítems inversos.
